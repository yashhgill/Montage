...
const SERVICES = [
  ...
  },
  {
    key: "photobooth",
    name: "360\u00b0 Photobooth",
    tagline: "Slow-mo 360 videos, prints & instant shares",
    fullDay: false,
    packages: [
      { id: "photobooth-service", name: "Photobooth Service", price: "RM 900", pax: "3 hours \u00b7 1 crew", poster: `${R2}/photobooth-service.jpg`,
        points: ["3 hours service time", "Unlimited pictures for 3 hours", "Instant printed photo keepsakes", "1 crew included", "Transportation included", "Add-on: RM150 per additional hour"] },
      { id: "360-spin-booth", name: "360 Spin Booth", price: "RM 900", pax: "3 hours \u00b7 1 crew", poster: `${R2}/360-spin-booth.jpg`,
        points: ["3 hours service time", "Unlimited photo & video sessions", "Edited digital copies provided", "Videos enhanced with music", "1 crew + transportation included", "Add-on: RM150 per additional hour"] },
    ],
  },
  {
    key: "sound",
    name: "Sound & Lighting",
    tagline: "PA systems, LED washes & big screens",
    fullDay: false,
    packages: [
      { id: "sound-system", name: "Sound System", price: "RM 2,500", pax: "Venue consultation included", poster: `${R2}/sound.jpg`,
        points: ["Clear, high-quality sound", "Speaker & subwoofer setup by venue size", "Venue consultation included", "Custom setup for small to large venues"] },
      { id: "lighting", name: "Lighting", price: "RM 2,000", pax: "Venue consultation included", poster: `${R2}/lighting.jpg`,
        points: ["Professional spotlight placement", "Lighting tailored to your event", "Custom setup small to large venues", "Venue consultation included"] },
      { id: "led-screen", name: "LED Screen", price: "RM 4,500", pax: "4m x 2m \u00b7 by venue size", poster: `${R2}/led-screen.jpg`,
        points: ["HD 4K resolution", "Seamless panel finish, no gaps", "On-site professional support", "Setup & teardown included", "Transport within Klang Valley"] },
    ],
  },
  {
    key: "video",
    name: "Video & Photography",
    tagline: "Cinematic highlights & candid coverage",
    fullDay: false,
    packages: [
      { id: "photo-shoot-burn", name: "Photography \u2014 Shoot & Burn", price: "RM 900", pax: "All digital photos delivered", poster: `${R2}/photography.jpg`,
        points: ["Experienced professional photographer", "Beautiful angle shots", "Candid & memorable moments", "All digital photos delivered"] },
      { id: "photo-album", name: "Photography with Album", price: "RM 1,900", pax: "100\u2013120 photos in album", poster: `${R2}/photography.jpg`,
        points: ["Everything in Shoot & Burn", "High-quality album (100\u2013120 photos)", "Premium event coverage", "High-quality photo printing"] },
      { id: "videography", name: "Videography", price: "RM 2,000", pax: "Full event coverage", poster: `${R2}/videography.jpg`,
        points: ["1 professional videographer", "1 cinematic montage video", "Full coverage start to end", "Comprehensive event storytelling"] },
    ],
  },
  {
    key: "games",
    name: "Game Corners",
    tagline: "Inflatables, arcade, consoles & carnival games",
    fullDay: false,
    packages: [
      { id: "inflatable-small", name: "Small Inflatable", price: "RM 1,000", pax: "6 hours service", poster: `${R2}/inflatable.jpg`,
        points: ["Small inflatable", "6 hours service", "Supervised safe setup", "Crew charges RM150 per crew"] },
      { id: "inflatable-medium", name: "Medium Inflatable", price: "RM 1,800", pax: "6 hours service", poster: `${R2}/inflatable.jpg`,
        points: ["Medium inflatable", "6 hours service", "Supervised safe setup", "Crew charges RM150 per crew"] },
      { id: "inflatable-large", name: "Large Inflatable", price: "RM 2,800", pax: "6 hours service", poster: `${R2}/inflatable.jpg`,
        points: ["Large inflatable", "6 hours service", "Supervised safe setup", "Crew charges RM150 per crew"] },
      { id: "ps5-rental", name: "PS5 Rental", price: "RM 850", pax: "6 hours rental", poster: `${R2}/ps5-rental.jpg`,
        points: ["PS5 console + TV included", "PS5 controllers", "Endless fun & games", "Crew add-on RM150 per person"] },
      { id: "racing-simulator", name: "Racing Simulator", price: "RM 1,800", pax: "6 hours rental", poster: `${R2}/racing-simulator.jpg`,
        points: ["TV & PS controller included", "Premium racing simulator setup", "Immersive interactive fun", "Crew RM150 per person"] },
      { id: "claw-machine", name: "Claw Machine", price: "RM 1,200", pax: "6 hours rental", poster: `${R2}/claw-machine.jpg`,
        points: ["Prize value & win rate adjustable", "Gifts arrangeable on request", "Interactive arcade fun", "Crew RM150 per person"] },
      { id: "arcade-games", name: "Arcade Games", price: "RM 1,200", pax: "6 hours rental", poster: `${R2}/arcade-games.jpg`,
        points: ["Multiple arcade games available", "Fun for all ages", "Premium event setup", "Crew RM150 per person"] },
      { id: "carnival", name: "Carnival Entertainment", price: "RM 350", pax: "From \u00b7 per game", poster: `${R2}/carnival.jpg`,
        points: ["6 exciting games available", "1 dedicated crew included", "Small gifts for winners", "Queue stand for fair play", "Book all 6 & get 1 free crew"] },
    ],
  },
  {
    key: "entertainers",
    ...
    packages: [
      { id: "caricature", name: "Caricature Service", price: "RM 750", pax: "2 hours of service", poster: `${R2}/caricature.jpg`,
        points: ["Live caricature artist", "Fast on-the-spot sketching", "Creative, personalised keepsakes", "Great for guests of all ages"] },
      { id: "face-painting", name: "Face Painting", price: "RM 550", pax: "2 hours of service", poster: `${R2}/face-painting.jpg`,
        points: ["Safe & hygienic non-toxic paint", "Experienced professional artist", "Great for kids & adults", "Wide variety of designs"] },
      { id: "clown-balloons", name: "Clown with Balloons", price: "RM 550", pax: "2 hours", poster: `${R2}/clown.jpg`,
        points: ["Professional clown", "Unlimited balloon sculpture", "Full costume & makeup", "Funny & entertaining"] },
      { id: "clown-magic", name: "Clown + Magic Show", price: "RM 850", pax: "2 hours", poster: `${R2}/clown.jpg`,
  ...
  },
  {
    ...
    tagline: "Chauffeur-driven wedding conveyance",
    fullDay: false,
    packages: [
      { id: "wedding-conveyance", name: "Chauffeur-Driven Conveyance", price: "RM 900", pax: "Half day \u00b7 12 hours", poster: `${R2}/wedding-conveyance.jpg`,
        points: ["Decoration matching your wedding theme", "Freshly cleaned car & nice interior", "Professional chauffeur included", "Professional attire & grooming", "12 hours of service"] },
    ],
  },
];
